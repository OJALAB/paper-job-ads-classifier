...
expert_quality <- hand_selected[id_ogl %in% hand_selected[!is.na(id_ogl), .N, id_ogl][N==3]$id_ogl, 
  ...
  transform(pair12_d1 = substr(e_1,1,1) == substr(e_2,1,1),
            ...
            e_1_1 = as.factor(substr(e_1,1,1)),
            e_2_1 = as.factor(substr(e_2,1,1)),
            e_3_1 = as.factor(substr(e_3,1,1)),
            e_1_2 = as.factor(substr(e_1,1,2)),
            e_2_2 = as.factor(substr(e_2,1,2)),
            e_3_2 = as.factor(substr(e_3,1,2))
            ) |>
  ## overall comparisons
...
```{r}
svykappa(~e_1_1+e_2_1, expert_quality_svy) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}() 
svykappa(~e_1_1+e_3_1, expert_quality_svy) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}()
svykappa(~e_2_1+e_3_1, expert_quality_svy) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}()
```

```{r}
kappam.fleiss(expert_quality_svy$variables[, c("e_1_1", "e_2_1", "e_3_1")], detail = T)
```
...
expert_quality_after <- hand_selected[id_ogl %in% hand_selected[!is.na(id_ogl), .N, id_ogl][N==3]$id_ogl, 
  ...
  transform(pair12_d1 = substr(e_1,1,1) == substr(e_2,1,1),
            ...
            pair13_d6 = substr(e_1,1,6) == substr(e_3,1,6),
            pair23_d6 = substr(e_2,1,6) == substr(e_3,1,6),
            e_1_1 = substr(e_1,1,1),
            e_2_1 = substr(e_2,1,1),
            e_3_1 = substr(e_3,1,1)
            ) |>
  ## overall comparisons
  transform(all_d1 = pair12_d1 & pair13_d1 & pair23_d1,
            all_d2 = pair12_d2 & pair13_d2 & pair23_d2,
...
```{r}
svykappa(~e_1_1+e_2_1, expert_quality_after_svy) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}() 
svykappa(~e_1_1+e_3_1, expert_quality_after_svy) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}()
svykappa(~e_2_1+e_3_1, expert_quality_after_svy) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}()
```

```{r}
kappam.fleiss(expert_quality_after_svy$variables[, c("e_1_1", "e_2_1", "e_3_1")], exact = T, detail = T)
```
...
cbop_hand <- cbop_hand[!(d_expert %in% c(1,6) | d_cbop %in% c(1,6))]
...
```{r}
svykappa(~d_expert+d_cbop, cbop_hand_svy) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}() 
svykappa(~d_expert+d_cbop, subset(cbop_hand_svy, ekspert == 1)) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}() 
svykappa(~d_expert+d_cbop, subset(cbop_hand_svy, ekspert == 2)) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}() 
svykappa(~d_expert+d_cbop, subset(cbop_hand_svy, ekspert == 3)) |> {\(x) round(c(x[1]*100,confint(x)*100),1)}() 
```
